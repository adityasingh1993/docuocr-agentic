...
class LocalVLMClient:
    ...
    def _prompt(
        ...
        return (
            ...
            "free-text values; preserve their literal OCR text. fieldHints may include "
            "groupLabelAliases and valuePart. When valuePart is first_token or "
            "remaining_tokens, a literal contiguous part of one full-name OCR span may "
            "be returned and the same span must be cited. Do not infer a missing name "
            "part. A string rawValue must be "
